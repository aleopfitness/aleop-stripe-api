...
console.log('Fallback email utilisé pour ' + customerEmail + ', ID trouvé : ' + memberId); // Log pour debug fallback
}
...
console.log('Recherche Member par email ' + email + ' : ' + data.data.length + ' résultats trouvés'); // Log nombre résultats
...
'athletyx': 'athletyx',
'power-flow': 'power_flow', // Ajusté pour match logs
